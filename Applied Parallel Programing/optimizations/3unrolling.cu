...
__global__ void conv_forward_kernel(float *__restrict y, const float *__restrict x, const float *k, const int B, const int M, const int C, const int H, const int W, const int K)
{
    /*
