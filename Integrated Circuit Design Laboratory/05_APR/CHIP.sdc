...
# Created by write_sdc on Sun Jun 12 08:03:16 2022
...
set_input_delay -clock clk  10  [get_ports start]
set_input_delay -clock clk  10  [get_ports {stop[15]}]
set_input_delay -clock clk  10  [get_ports {stop[14]}]
set_input_delay -clock clk  10  [get_ports {stop[13]}]
set_input_delay -clock clk  10  [get_ports {stop[12]}]
set_input_delay -clock clk  10  [get_ports {stop[11]}]
set_input_delay -clock clk  10  [get_ports {stop[10]}]
set_input_delay -clock clk  10  [get_ports {stop[9]}]
set_input_delay -clock clk  10  [get_ports {stop[8]}]
set_input_delay -clock clk  10  [get_ports {stop[7]}]
set_input_delay -clock clk  10  [get_ports {stop[6]}]
set_input_delay -clock clk  10  [get_ports {stop[5]}]
set_input_delay -clock clk  10  [get_ports {stop[4]}]
set_input_delay -clock clk  10  [get_ports {stop[3]}]
set_input_delay -clock clk  10  [get_ports {stop[2]}]
set_input_delay -clock clk  10  [get_ports {stop[1]}]
set_input_delay -clock clk  10  [get_ports {stop[0]}]
set_input_delay -clock clk  10  [get_ports {inputtype[1]}]
set_input_delay -clock clk  10  [get_ports {inputtype[0]}]
set_input_delay -clock clk  10  [get_ports {frame_id[4]}]
set_input_delay -clock clk  10  [get_ports {frame_id[3]}]
set_input_delay -clock clk  10  [get_ports {frame_id[2]}]
set_input_delay -clock clk  10  [get_ports {frame_id[1]}]
set_input_delay -clock clk  10  [get_ports {frame_id[0]}]
